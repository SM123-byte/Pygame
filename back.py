...
background_image = pygame.transform.scale(
    pygame.image.load('/Users/swagatmohanty/Documents/Python/Pygame/background.jpeg').convert(), (SCREEN_HEIGHT, SCREEN_WIDTH)) 

penguin_image = pygame.transform.scale(
    pygame.image.load('/Users/swagatmohanty/Documents/Python/Pygame/Penguin .png').convert_alpha(), (200, 200))
